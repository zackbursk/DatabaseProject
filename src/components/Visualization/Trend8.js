...
const Trend8 = () => {
  ...
  const [airplaneName,setAirplaneName]=useState("Boeing 737-800")
  ...
  function queryData()
  {
    axios.get(`http://localhost:5000/api/trend8/${airplaneName}`).then(res => {
  ...
  />
    ...
    <form>
        <label>
        <p>Airplane Name: </p>
        <input type="text" name="Name" value={airplaneName} onChange={handleAirplaneNameChange}/>
        </label>
      </form>
